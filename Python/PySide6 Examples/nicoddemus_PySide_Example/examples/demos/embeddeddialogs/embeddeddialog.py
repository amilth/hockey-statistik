...
class Ui_embeddedDialog(object):
    def setupUi(self, embeddedDialog):
        ...
        self.formLayout.setWidget(
            0, QtGui.QFormLayout.FieldRole, self.layoutDirection)
        ...
        self.formLayout.setWidget(
            1, QtGui.QFormLayout.FieldRole, self.fontComboBox)
    ...
    def retranslateUi(self, embeddedDialog):
        embeddedDialog.setWindowTitle(QtGui.QApplication.translate(
            "embeddedDialog", "Embedded Dialog", None, QtGui.QApplication.UnicodeUTF8))
        self.label.setText(QtGui.QApplication.translate(
            "embeddedDialog", "Layout Direction:", None, QtGui.QApplication.UnicodeUTF8))
        self.layoutDirection.addItem(QtGui.QApplication.translate(
            "embeddedDialog", "Left to Right", None, QtGui.QApplication.UnicodeUTF8))
        self.layoutDirection.addItem(QtGui.QApplication.translate(
            "embeddedDialog", "Right to Left", None, QtGui.QApplication.UnicodeUTF8))
        self.label_2.setText(QtGui.QApplication.translate(
            "embeddedDialog", "Select Font:", None, QtGui.QApplication.UnicodeUTF8))
        self.label_3.setText(QtGui.QApplication.translate(
            "embeddedDialog", "Style:", None, QtGui.QApplication.UnicodeUTF8))
        self.label_4.setText(QtGui.QApplication.translate(
            "embeddedDialog", "Layout spacing:", None, QtGui.QApplication.UnicodeUTF8))
