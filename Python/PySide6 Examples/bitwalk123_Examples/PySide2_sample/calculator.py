...
class Calculator(QWidget):
    # Key Layout
    keys_info = [
        {"label": "Ｃ", "x": 0, "y": 1, "w": 1, "h": 1,
            "name": "Cls", "method": "on_clear"},
        {"label": "√", "x": 1, "y": 1, "w": 1, "h": 1,
            "name": "Fnc", "method": "on_function"},
        {"label": "±", "x": 2, "y": 1, "w": 1, "h": 1,
            "name": "Fnc", "method": "on_function"},
        {"label": "÷", "x": 3, "y": 1, "w": 1, "h": 1,
            "name": "Ope", "method": "on_operation"},
        {"label": "７", "x": 0, "y": 2, "w": 1, "h": 1,
            "name": "Key", "method": "on_number"},
        {"label": "８", "x": 1, "y": 2, "w": 1, "h": 1,
            "name": "Key", "method": "on_number"},
        {"label": "９", "x": 2, "y": 2, "w": 1, "h": 1,
            "name": "Key", "method": "on_number"},
        {"label": "×", "x": 3, "y": 2, "w": 1, "h": 1,
            "name": "Ope", "method": "on_operation"},
        {"label": "４", "x": 0, "y": 3, "w": 1, "h": 1,
            "name": "Key", "method": "on_number"},
        {"label": "５", "x": 1, "y": 3, "w": 1, "h": 1,
            "name": "Key", "method": "on_number"},
        {"label": "６", "x": 2, "y": 3, "w": 1, "h": 1,
            "name": "Key", "method": "on_number"},
        {"label": "−", "x": 3, "y": 3, "w": 1, "h": 1,
            "name": "Ope", "method": "on_operation"},
        {"label": "１", "x": 0, "y": 4, "w": 1, "h": 1,
            "name": "Key", "method": "on_number"},
        {"label": "２", "x": 1, "y": 4, "w": 1, "h": 1,
            "name": "Key", "method": "on_number"},
        {"label": "３", "x": 2, "y": 4, "w": 1, "h": 1,
            "name": "Key", "method": "on_number"},
        {"label": "＋", "x": 3, "y": 4, "w": 1, "h": 2,
            "name": "Ope", "method": "on_operation"},
        {"label": "０", "x": 0, "y": 5, "w": 1, "h": 1,
            "name": "Key", "method": "on_number"},
        {"label": "・", "x": 1, "y": 5, "w": 1, "h": 1,
            "name": "Key", "method": "on_dot"},
        {"label": "＝", "x": 2, "y": 5, "w": 1, "h": 1,
            "name": "Ope", "method": "on_equal"},
    ]
