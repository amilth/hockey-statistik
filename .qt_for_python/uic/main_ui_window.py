...
"}")
        ...
        self.pushButtonConnectToDB = QPushButton(self.button_coll)
...
"          ")
        ...
        self.pushButtonTopTenEvents = QPushButton(self.button_coll)
        self.pushButtonTopTenEvents.setObjectName(u"pushButtonTopTenEvents")
        self.pushButtonTopTenEvents.setMaximumSize(QSize(250, 16777215))
        font1 = QFont()
        font1.setFamilies([u"MS Shell Dlg 2"])
        font1.setPointSize(16)
        font1.setBold(False)
        font1.setItalic(False)
        self.pushButtonTopTenEvents.setFont(font1)

        self.verticalLayout.addWidget(self.pushButtonTopTenEvents)

        self.pushButtonDisconnectFromDB = QPushButton(self.button_coll)
        ...
        self.tableWidgetTopTen.setMaximumSize(QSize(250, 16777215))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButtonTopTenEvents.setText(QCoreApplication.translate("MainWindow", u"Get top 10 events", None))
